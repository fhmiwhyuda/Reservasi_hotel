    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?= base_url('Admin/welcome')?>" class="d-block"><?= $_SESSION['user']->Nama; ?></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="?page=fasilitasumum" class="nav-link">
                                <i class="nav-icon fas fa-pencil-alt"></i>
                                <p>Fasilitas umum</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="?page=fasilitaskamar" class="nav-link">
                                <i class="nav-icon fas fa-pencil-alt"></i>
                                <p>Fasilitas kamar</p>
                            </a>
                        </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <h1 class="m-0 mb-3">Admin Hotel Hebat</h1>
                </div>
                <!-- /.container-fluid -->
            </section>
